# 🧝‍♀️ This is Tanvi.
### I'm a Computer Science student | Fullstack and AI enthusiast | Product driven builder.
...
+	Contributed to dataset expansion, cultural preservation, and model behaviour refinement for Telugu NLP tasks.
---
# 🐉 Featured Projects
...
+ **Learning Repository** : a clean, compact learning notes website (HTML/CSS/JS)
---
# 🛠️ What I work with (Languages + Code Editors)
+ Python
+ Java
+ React
+ Node
...
+ Working with fast, ambitious teams
+ Solving real problems, not just tutorial tasks
+ Your wellbeing
---
# 👗 Outside tech
I write poetry, read books, cook something nice, cycle along the lake, watch movies, workout, and listen to music. 
